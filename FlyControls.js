...
import { GamepadCtl } from "./GamepadCtl.js";
...
class FlyControls extends EventDispatcher {
  constructor(object, domElement) {
    ...
    this.controller = new GamepadCtl();
    ...
    this.update = function (delta) {
      ...
      scope.object.translateX(this.controller.pan.x * moveMult);
      scope.object.translateY(this.controller.pan.y * moveMult);
      scope.object.translateZ(this.controller.pan.z * moveMult);

      this.moveState.forward = this.controller.forward;
      this.moveState.back = this.controller.backward;
      this.updateMovementVector();
